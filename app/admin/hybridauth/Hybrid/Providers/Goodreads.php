	...
	*/
	function loginFinish()
	{
		...
		if ( ! isset($_REQUEST['oauth_token']) || ( isset( $_REQUEST['authorize'] ) && $_REQUEST['authorize'] == "0" ) ){ 
			//$the_oauth_token = $_REQUEST['oauth_token'];
			//$the_authorize = $_REQUEST['authorize'];
			throw new Exception( "Authentication failed! The user denied your request. oauthotoken: ", 5 );
